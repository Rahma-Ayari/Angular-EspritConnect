// ============================================================
// sidebar.component.ts — EspritConnect Admin
// Corrigé : ajout de iconPath() et isExpanded()
// ============================================================
...
export class SidebarComponent {
  ...
  @Output() navigate = new EventEmitter<SidebarItem>();
  @Output() closeMobile = new EventEmitter<void>();

  /** Garde l'état des menus ouverts (par id) */
  expandedIds = new Set<string>(['mail']); // "mail" ouvert par défaut

  /** Détermine si un item parent est ouvert */
  isExpanded(item: SidebarItem): boolean {
    return this.expandedIds.has(item.id);
  }

  /** Gère le clic : ouvre/ferme le sous-menu ou navigue */
  ...
  /**
   * Retourne le path SVG selon le nom d'icône.
   * Tous les paths sont des icônes Material Design.
   */
